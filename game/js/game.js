...
/*!
 * 
 * GAME SETTING CUSTOMIZATION 
 * 
 */

var bgColour = "#FDDB27"; //background colour
...
var timerCircleColour = '#00B1D2'; //timer icon colour
...
var howToPlayMessageUp = 'Drag Numbers and Operations on the Paper';
var howToPlayMessageDown = 'To match the correct answer';
...
function buildGameButton(){
	...
	buttonHowToPlay.cursor = "pointer";
	buttonHowToPlay.addEventListener("click", function(evt){
		toggleHowTo(true);
		toggleOption();
	});
...
function goPage(page){
	...
	switch(page){
		...
		case 'result':
			...
			if(highScore<=totalSolve){highScore = totalSolve;}
			if(highScore>0){highScoreTxt.text = highScoreTxtShadow.text = "🔥 High Score: " + highScore + " 🔥";}
			quoteTxt.text = quoteTxtShadow.text = "❝ " + quote() + " ❞";
...
/*!
 * 
 * HOW TO PLAY - This is the function that runs to toggle how to play instructions
 * 
 */
function toggleHowTo(con){
	howToPlayContainer.visible = con;
	toggleGameTimerPause(con);
}
/*!
 * 
